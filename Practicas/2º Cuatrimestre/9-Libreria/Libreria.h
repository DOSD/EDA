...
public:
	...
	*/
	void an_libro(const string& libro, unsigned int n);
	/**
	...
	*/
	bool esta_libro(const string& libro) const;
	/**
	...
	*/	
	void elim_libro(const string& libro);
	/**
	...
	*/
	int num_ejemplares(const string& libro) const;
	/**
...
*****/
	Diccionario<string,int> _libros;
	int _total_libros;
};
