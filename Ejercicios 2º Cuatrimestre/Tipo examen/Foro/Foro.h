...
typedef Lista<MID>::Iterator msg;
...
public:
   ...
   */
   Mensaje(MID id, const string& remitente, const string& asunto, const string& cuerpo,msg pos);	
   /**
...
private:
  ...
  msg _posicion;	//posicion en la lista de mensajes
};
